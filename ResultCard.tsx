    ...
    <div className="p-4 space-y-6 animate-slide-up pb-20">
      <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100">
        <div className={`${binInfo.color} p-8 text-white text-center`}>
          {result.imageUrl && (
            <div className="mb-4 flex justify-center">
              <img src={result.imageUrl} alt={result.itemName} className="w-24 h-24 object-contain bg-white/20 rounded-2xl p-2" />
            </div>
          )}
        ...
        <div className="p-6 space-y-6">
          <section>
            <h3 className="text-[11px] font-black text-slate-400 uppercase tracking-widest mb-2">Consigne de tri</h3>
