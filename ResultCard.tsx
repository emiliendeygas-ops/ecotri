        ...
        <div className="p-6 space-y-6">
          ...
          {result.nearbyPoints?.length && userLocation && (
            <section className="space-y-4">
              ...
              <a href={result.nearbyPoints[activePoint].uri} target="_blank" rel="noopener noreferrer" className="block text-center bg-slate-100 text-slate-600 py-3 rounded-xl font-bold text-sm">Voir l'itinéraire 📍</a>
            </section>
          )}
